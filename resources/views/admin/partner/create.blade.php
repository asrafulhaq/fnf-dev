...
@section('dash-title','Add new  opartner')
...
@section('dash-page-content')
    ...
    <div class="col-sm-12">
        ...
        <section class="panel panel-default">
            <header class="panel-heading font-bold">Add new partner</header>
            <div class="panel-body">
                <form class="bs-example form-horizontal" action="{{ route('media-partner.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            <button type="submit" class="btn btn-sm btn-default">Add partner</button>
                            <a class="btn btn-sm btn-default" href="{{ route('media-partner.index') }}">Back</a>
                        </div>
                    </div>
                </form>
            </div>
